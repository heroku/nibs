...
function getPointBalance(userId) {
    return db.query('select sum(eitech__points__c) as points from salesforce.eitech__interaction__c where eitech__Contact__r__eitech__LoyaltyId__c=$1', [userId], true);
}
