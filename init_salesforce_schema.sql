...
CREATE TABLE IF NOT EXISTS salesforce.contact (
    ...
    leadsource      TEXT,
    accountid       TEXT,
    eitech__pictureURL__c   TEXT,
    eitech__preference__c   TEXT,
    eitech__size__c         TEXT,
    eitech__loyaltyid__c    TEXT,
    eitech__password__c     TEXT,
    eitech__fbuserid__c     TEXT,
    eitech__gender__c       TEXT,
	eitech__TypeCompte__c	TEXT,
...
CREATE TABLE IF NOT EXISTS salesforce.campaign (
    ...
    enddate         DATE,
    description     TEXT,
    eitech__image__c        TEXT,
    eitech__campaignpage__c TEXT,
    eitech__publishdate__c  DATE,
    type            TEXT,
    status          TEXT
  );
...
INSERT INTO salesforce.campaign (id, name, description, eitech__image__c, type, status) VALUES
...
INSERT INTO salesforce.product2 (id, name, description, eitech__image__c, family) VALUES
